...
```{r include=FALSE, eval=!file.exists("img/flextable-title-ex-01.png") && require("doconv") && locatexec::exec_available("word")}
doconv::to_miniature(filename = docx_file, fileout = "img/flextable-title-ex-01.png")
```

![](img/flextable-title-ex-01.png)
