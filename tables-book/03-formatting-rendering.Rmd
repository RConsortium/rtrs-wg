...
Alternatively, table objects can be converted to the format 
...
adsl <- cadsl
library(tables)
sd_in_parens <- function(x) paste0("(", round(sd(x), 1), ")")
...
tab |> toKable() |> kableExtra::footnote("This is a footnote")
```
