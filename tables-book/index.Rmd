...
for this book. For now you can install the latest 
versions of the packages yourself by installing the `pak` package
from CRAN, then

```{r, eval = FALSE}
pak::pkg_install("RConsortium/rtrs-wg/tools/fakepkg", upgrade = TRUE)
```
