...
```{r, eval = FALSE}
install.packages(c("rtables", "gt", "remotes", "tidyverse", "bookdown"))
...
# This document needs the unreleased tables v 0.9.9
remotes::install_github("rforge/tables/pkg/tables")
```
