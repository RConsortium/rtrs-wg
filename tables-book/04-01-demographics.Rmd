...
Please note that the`tfrmt` package is intended for use with mock or ARD (analysis results data). 
...
For this demonstration, we will use the `kableExtra`
package to modify the table into a format similar
to the other packages.

```{r}
resetSession()
# function to convert column to subgroup
