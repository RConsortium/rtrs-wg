...
The package is on CRAN, but this document currently requires
the development version.  Source is maintained on R-forge
...
if (!requireNamespace("tables", quietly = TRUE) ||
    packageVersion("tables") < "0.9.9")
  stop("This document requires tables version 0.9.9 or higher.")
```
