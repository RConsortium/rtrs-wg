...
Tables are a major component for analyzing clinical trials data and to communicate results to the study teams, in
...
group. The aim is to publish a series of papers on various aspects of table creation to analyze report clinical trials
data with R.
